...
DTSI_FILE_DICT+=( 
        ...
        ["Auvidea_JNX42_XavierNX"]="tegra194-camera-vc-mipi-cam.dtsi"
          ...
          ["Boson22_OrinNano"]="tegra234-camera-vc-mipi-cam.dtsi"
)
...
DTSI_DEST_DICT+=( 
        ...
        ["Auvidea_JNX42_XavierNX"]="$KERNEL_SOURCE/hardware/nvidia/platform/t19x/jakku/kernel-dts/common"
          ...
          ["Boson22_OrinNano"]="$KERNEL_SOURCE/hardware/nvidia/platform/t23x/p3768/kernel-dts/cvb"
)
...
case $VC_MIPI_SOM in
Nano|NanoSD|Nano2GB|OrinNano8GB_NVME)
