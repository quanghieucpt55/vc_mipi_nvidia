...
DTSI_FILE_DICT+=(["Boson22_OrinNano"]="tegra234-camera-vc-mipi-cam.dtsi")
...
DTSI_DEST_DICT+=(["Boson22_OrinNano"]="$KERNEL_SOURCE/hardware/nvidia/platform/t23x/p3768/kernel-dts/cvb")
